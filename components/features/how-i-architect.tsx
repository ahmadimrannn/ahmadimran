...
export function HowIArchitect() {
    return (
        <section id="how-i-architect" className="w-full bg-[#fafaf8] dark:bg-black text-[#000000] dark:text-white py-24 sm:py-32 transition-colors">
            <div className="max-w-5xl mx-auto px-6 sm:px-8">
                ...
                <div className="relative border-l border-[#1A1A1A]/10 dark:border-white/10 ml-3 sm:ml-4 pl-6 sm:pl-10 space-y-12 sm:space-y-16">
                    {steps.map((step) => (
                        <motion.div
                            key={step.number}
                        ...
                        >
                            ...
                            <div className="absolute -left-[31px] sm:-left-[47px] top-1.5 w-2.5 h-2.5 rounded-full bg-[#fafaf8] dark:bg-black border border-[#1A1A1A]/20 dark:border-white/30" />
