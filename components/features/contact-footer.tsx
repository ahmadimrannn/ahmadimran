    ...
    return (
        <footer id="contact" className="relative border-t border-neutral-200 dark:border-white/10 pt-28 pb-14 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-6 sm:px-8 space-y-20">
                {/* Main Section: Side-by-Side Content & Contact Form */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                    ...
                    >
                        ...
                        <motion.div variants={FADE_UP_VARIANT} className="space-y-4">
                            ...
                            <h2 className="text-4xl md:text-7xl font-geist font-medium tracking-tighter bg-linear-to-b from-neutral-950 to-neutral-500 dark:from-white dark:to-neutral-500 bg-clip-text text-transparent leading-[1.05]">
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="text-left font-mono">
                                    ...
                                    <p className="text-sm sm:text-base font-semibold text-neutral-900 group-hover:text-emerald-600 dark:text-white dark:group-hover:text-emerald-300 font-geist transition-colors">
                                        {email}
                                    </p>
                                </div>
                            </button>
                            ...
                            >
                                ...
                                <span className="font-inter font-semibold">Send Mail</span>
                            ...
                            <a
                                ...
                                className="flex items-center gap-1 px-5 py-4 rounded-2xl bg-white/80 border border-neutral-200 hover:bg-neutral-100 text-neutral-800 dark:bg-white/5 dark:border-white/10 dark:hover:bg-white/10 dark:text-white transition-all duration-300 font-mono text-sm shadow-xs"
                            >
                                ...
                                <span className="font-inter font-semibold">GitHub</span>
                                <ArrowUpRight size={16} className="text-neutral-400" />
                            </a>
                            ...
                            >
                                ...
                                <span className="font-inter font-semibold">LinkedIn</span>
                                <ArrowUpRight size={16} className="text-neutral-400" />
                            </a>
                        </motion.div>
                    </motion.div>
                    ...
                    <div className="w-full border rounded-xl px-6 py-8 md:py-12 md:px-12">
                        <ContactForm className="w-full" />
                    </div>
                </div>

                {/* Separate Footer Copyright Bar at the Bottom */}
                <motion.div
                    variants={FADE_UP_VARIANT}
                    initial="hidden"
                    whileInView="visible"
