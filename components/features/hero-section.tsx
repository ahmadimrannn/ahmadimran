      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 text-center flex flex-col items-center">
        ...
        >
          ...
          <motion.div variants={FADE_UP_VARIANT} className="mb-6">
            <div className="rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3 py-1 text-xs text-emerald-700 dark:text-emerald-400 inline-flex items-center gap-2 shadow-sm">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
                <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500" />
              </span>
              <span>Available for Agentic AI Eng &amp; Contract Roles</span>
            </div>
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-geist font-medium tracking-tighter text-neutral-950 dark:text-white leading-[1.05] max-w-4xl transition-colors duration-300"
          >
